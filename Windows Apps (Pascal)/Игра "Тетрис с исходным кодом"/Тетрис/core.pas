...
type Figure_Array = array[1..Figure_points] of fig_el_Obj;
...
type Z_Invalid = object (Z_Normal)  {объект - фигура "Неравильная буква Z" (наследник танка)}
private
procedure RoundToRotated(var temp_array : figure_array); virtual;  {повернуть по часовой}
procedure RoundToNormal (var temp_array : figure_array); virtual;  {повернуть против часовой}
public
...
type pQuadro = ^Quadro_Obj;
     pTank   = ^Tank_Obj;
     pG_Normal = ^G_Normal;
     pG_Invalid = ^G_Invalid;
     pZ_Normal = ^Z_Normal;
     pZ_Invalid = ^Z_Invalid;
     pStick = ^Stick;
